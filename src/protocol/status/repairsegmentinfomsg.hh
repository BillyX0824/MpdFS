 ...
 * Structure : { segmentId, deadBlockIds, newChunkserverIds }
 */
...
public:
	 ...
	 * @param	newChunkserverIds		List of new chunkserver to put the blocks
	 */

	RepairSegmentInfoMsg (Communicator* communicator, uint32_t sockfd, uint64_t
		segmentId, vector<uint32_t> deadBlockIds, vector<uint32_t> newChunkserverIds);
...
private:
	...
	vector<uint32_t> _newChunkserverIds;
};

 ...
 */
GetSegmentIdListReplyMsg::GetSegmentIdListReplyMsg(Communicator* communicator, uint32_t requestId, uint32_t masterSockfd, const vector<uint64_t> &segmentIdList, const vector<uint32_t> &primaryList) :
		Message(communicator) {

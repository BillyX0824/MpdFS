...
public:
	 ...
	 * @param	masterSockfd	Socket descriptor of Master
	 * @param	path	Requested directory path
	 */

	ListDirectoryRequestMsg (Communicator* communicator, uint32_t clientId, uint32_t masterSockfd, const string &path);

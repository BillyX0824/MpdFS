...
SegmentDataMsg::SegmentDataMsg(Communicator* communicator, uint32_t chunkserverSockfd,
...
#ifdef COMPILE_FOR_CHUNKSERVER
	chunkserver->putSegmentDataProcessor(_msgHeader.requestId, _sockfd, _segmentId, _offset, _length, _dataMsgType, _updateKey, _payload);
#endif
#ifdef COMPILE_FOR_CLIENT

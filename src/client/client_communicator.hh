...
public:
	void display();
	void chunkserverIdListRequest();
	void segmentMessageHandler();

	/**
	 * Upload a file to CHUNKSERVER
	...
	/**
	 * @brief	Send a request to CHUNKSERVER for the segment
	 * @param dstSockfd CHUNKSERVER Socket Descriptor
	 ...
	 * 2. Repeatedly send data chunks to CHUNKSERVER
	...
	void putSegment(uint32_t clientId, uint32_t dstChunkserverSockfd,
	...
	/**
	 * Send a request to monitor to get Chunkserver List and connect 
	 */
	void getChunkserverListAndConnect();

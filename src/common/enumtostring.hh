...
public:
  static const char * toString( MsgType en ) {
    switch( en ) {
      ...
      case GET_CHUNKSERVER_LIST_REPLY: return "GET_CHUNKSERVER_LIST_REPLY";
      case GET_CHUNKSERVER_LIST_REQUEST: return "GET_CHUNKSERVER_LIST_REQUEST";
      case GET_CHUNKSERVER_STATUS_REPLY: return "GET_CHUNKSERVER_STATUS_REPLY";
      case GET_CHUNKSERVER_STATUS_REQUEST: return "GET_CHUNKSERVER_STATUS_REQUEST";
      ...
      case NEW_CHUNKSERVER_REGISTER: return "NEW_CHUNKSERVER_REGISTER";
      case ONLINE_CHUNKSERVER_LIST: return "ONLINE_CHUNKSERVER_LIST";
      case CHUNKSERVERSTAT_UPDATE_REPLY: return "CHUNKSERVERSTAT_UPDATE_REPLY";
      case CHUNKSERVERSTAT_UPDATE_REQUEST: return "CHUNKSERVERSTAT_UPDATE_REQUEST";
      case CHUNKSERVER_SHUTDOWN: return "CHUNKSERVER_SHUTDOWN";
      case CHUNKSERVER_STARTUP: return "CHUNKSERVER_STARTUP";
      case PUT_BLOCK_INIT_REPLY: return "PUT_BLOCK_INIT_REPLY";
      case PUT_BLOCK_INIT_REQUEST: return "PUT_BLOCK_INIT_REQUEST";
      case GET_DELTA_INIT_REQUEST: return "GET_DELTA_INIT_REQUEST";
  ...
  static const char * toString( ComponentType en ) {
    switch( en ) {
      ...
      case CHUNKSERVER: return "CHUNKSERVER";
    }
    return "???";
  }

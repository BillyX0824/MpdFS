#ifndef __MASTER_COMMUNICATOR_HH__
#define __MASTER_COMMUNICATOR_HH__
...
class MasterCommunicator: public Communicator {
public:
	...
	/**
	 * @brief	Reply Segment Information to Chunkserver
	 *
	 * @param	requestId	Request ID
	 * @param	connectionId	Connection ID
	 ...
	 * @param	requestId	Request ID
	 * @param	connectionId	Connection ID
	 * @param	chunkserverId		ID of the Chunkserver to be Recovered
	 ...
	 */
	void reportFailure(uint32_t chunkserverId, FailureReason reason);

...
public:
	...
	/**
	 * @brief	Read the list of segments stored by the CHUNKSERVER
	 * @param chunkserverId CHUNKSERVER ID
	 * @return list of segmentID owned by the CHUNKSERVER
	 */

	vector<uint64_t> readChunkserverSegmentList(uint32_t chunkserverId);

	/**
	 * @brief	Read the list of segments stored by the CHUNKSERVER as primary
	 * @param chunkserverId CHUNKSERVER ID
	 * @return list of segmentID owned by the CHUNKSERVER as primary
	 */

	vector<uint64_t> readChunkserverPrimarySegmentList(uint32_t chunkserverId);
	 ...
	 *
	 * @param	segmentId	ID of the Segment
	 * @param	primaryChunkserverId	ID of the Primary
	 */
	void setPrimary(uint64_t segmentId, uint32_t primaryChunkserverId);

	/**
	 * @brief	Select an acting primary CHUNKSERVER for the segment
	 ...
	 * @return Selected acting primary CHUNKSERVER ID
	 */

...
public:
	...
	/**
	 * @brief Find all segments owned by the chunkserver
	 * @param chunkserverId Chunkserver ID
	 * @return list of segmentId
	 */
	vector<uint64_t> findChunkserverSegments(uint32_t chunkserverId);

	/**
	 * @brief Find all the segments owned by the chunkserver as primary
	 * @param chunkserverId Chunkserver ID
	 * @return list of segmentId
	 */

	vector<uint64_t> findChunkserverPrimarySegments(uint32_t chunkserverId);

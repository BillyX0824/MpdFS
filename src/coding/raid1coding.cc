...
block_list_t Raid1Coding::getRequiredBlockSymbols(vector<bool> blockStatus,
	...
	// for Raid1 Coding, find the first running CHUNKSERVER
	vector<bool>::iterator it;
	it = find(blockStatus.begin(), blockStatus.end(), true);

	// not found (no CHUNKSERVER is running)
...
int*  Raid1Coding::getMatrix(string setting) {
}
uint32_t Raid1Coding::getWNumber(string setting){
}
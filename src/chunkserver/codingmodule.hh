...
class CodingModule {
    public:
         ...
         * @param codingScheme Coding Scheme
         * @param blockStatus A bool array containing the status of the CHUNKSERVER
		...
		/**
         * Get the coding matrix that the scheme uses
         * @param codingScheme Coding Scheme
         * @param setting Setting for the coding scheme
         * @return the coding matrix
         */
        int* getMatrix(CodingScheme codingScheme, string setting);
         ...
         * @param codingScheme Type of coding scheme
         * @param segmentSize Size of the coding segment
         * @return The number of w
         */
        uint32_t getWNumber(CodingScheme codingScheme, string setting);

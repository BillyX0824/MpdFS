...
void printResult(Clock::time_point tStart, Clock::time_point tRead,
	...
	cout << setprecision(2);
	cout << endl;
	cout << "Total Time Spent: " << durationTotal << " sechunkserver " << endl;
	cout << "Time Spent on Reading: " << durationRead << " sechunkserver " << endl;
	cout << "Time Spent on Coding: " << durationCode << " sechunkserver " << endl;
	cout << "Time Spent on Writing: " << durationWrite << " sechunkserver " << endl;
	cout << endl;
